...
try:
    ...
    return "Error: Could not fetch image. Please check the breed name or your connection."
...
def get_random_sub_breed_image(breed, sub_breed):
    ...
    try:
        ...
        return "Error: Could not fetch sub-breed image. Check the names or your connection."
...
def show_breeds(breeds_dict):
    ...
    try:
        ...
        print("Error: Could not display breed list.")
